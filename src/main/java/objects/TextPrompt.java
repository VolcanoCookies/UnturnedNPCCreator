	...
	implements FocusListener, DocumentListener
{
	...
	public TextPrompt(String text, JTextComponent component, int alpha) {
		this(text, component);
		changeAlpha(alpha);
	}
...
//  Implement DocumentListener
	...
	/**
	 * @wbp.factory
	 * @wbp.factory.parameter.source component textFieldDialogueID
	 */
	public static TextPrompt createTextPrompt(JTextComponent component) {
		TextPrompt textPrompt = new TextPrompt("Dialogue ID", component);
		return textPrompt;
	}
}