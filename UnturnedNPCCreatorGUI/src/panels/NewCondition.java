...
public class NewCondition extends JPanel {
	...
	public NewCondition() {
		...
		comboBoxZombieType = new JComboBox<Object>();
		comboBoxZombieType.setMaximumRowCount(12);
		comboBoxZombieType.setModel(new DefaultComboBoxModel<Object>(new String[] {"Any", "Normal", "Mega", "Crawler", "Sprinter", "Flanker Visible", "Flanker Invisible", "Burner", "Acid", "Boss Electric", "Boss Wind", "Boss Fire"}));
