...
public class CreditPanel extends JPanel {
	...
	public CreditPanel() {
		...
		textAppIcon.setAlignmentY(CENTER_ALIGNMENT);
		textAppIcon.setFont(new Font("Trebuchet MS", Font.PLAIN, 12));
		textAppIcon.setText("App icon created by <a href=\"http://www.freepik.com/:C\">Freepik</a> on www.flaticon.com");
		...
		gbc_textAppIcon.fill = GridBagConstraints.VERTICAL;
